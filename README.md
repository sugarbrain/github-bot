...
- Navigate to `github-bot` folder
- Select `github-bot.bot` file
...
msbot clone services --name "github-bot" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
